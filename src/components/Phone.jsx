    ...
    return (
        <>
            <div className="flex justify-center items-center min-h-screen w-full">
                <div className="w-[480px] bg-[#F6FAFF] p-5 rounded-xlg border-2 border-[#3584ED] shadow-md">
                    ...
                    <div className="flex flex-col items-center mb-4">
                        <div className="w-full h-80 bg-white border-2 border-[#3584ED] rounded-xlg relative mb-5">
                        </div>
